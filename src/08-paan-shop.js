...
export function updatePrices(menu, increase) {
 ...
 let newMenu = {...menu};
 let increasing = Object.entries(newMenu).map(([key, value]) => {
     return [key, value + increase];
 })
 let result = Object.fromEntries(increasing);
 return result; 
...
export function mergeDailySpecials(regularMenu, specialsMenu) {
  if(typeof regularMenu !== 'object' || typeof specialsMenu !== 'object') return {};
    let mergeObject = {...regularMenu, ...specialsMenu};
